		...
		public void RanPocketSimplesNc() {
			...
			if(Ori.startsWith("Hor")){
				...
				if(IniA==true){
					...
					ImprimirSecuenciaLineaNo.EscribirLinea("G00 G40 F"+ FeedRate + " X" + L3.format(Xi) + " Y" + L3.format(Yi));
					//implin = "G00 G40 F"+ FeedRate + " X" + L3.format(Xi) + " Y" + L3.format(Yi);//imprimo la pocicion del hueco
					//WriteLineNo(implin);
					
					ImprimirSecuenciaLineaNo.EscribirLinea("Z0.0");
...
//					System.out.println("Es menor");
					A02_GerarGcode_Slot.SalExt=true;
				}else{
					ImprimirSecuenciaLineaNo.EscribirLinea("G01 F"+(FeedRate*.75)+" Z-" + L3.format(Prof));
				...
				if((DTool*2)>Ancho){
					...
					if(IniA==true){
						...
						ImprimirSecuenciaLineaNo.EscribirLinea(implin);
						Yp=Yf;
						}
		...
		public void ContornoRanPocketSimplesNc() {
			...
			if(Ori.startsWith("Hor")){
				...
				if(IniA==true){
					...
					implin = "Z-"+(A02_GerarGcode_Slot.ProfTem-A02_GerarGcode_Slot.AngBase);//imprimo la pocicion del hueco
					ImprimirSecuenciaLineaNo.EscribirLinea(implin);

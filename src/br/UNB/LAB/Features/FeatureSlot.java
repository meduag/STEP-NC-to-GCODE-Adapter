...
public class FeatureSlot {
	...
	public int salirST=1;
		...
		public static double ValorProfundidad=0;
		 ...
		 do//asignacion de direcciones
			...
			if(ctokens==(sigDir+6)){//copia el primer token con la primera ferramenta
				...
				if(aCaracteres[0]==vir | aCaracteres[0]==parI | aCaracteres[0]==num){//solo copia numeros
						...
						StringTokenizer ValProDouble = new StringTokenizer(AxPl3d.ExtrairDadosAP3D(SecEnder.IndexacaoEnderecos.get(TempEnd)), "Z=;");//buscador de tokens con separadores activados
						ValorProfundidad = Double.parseDouble(ValProDouble.nextToken());//leo el proximo token

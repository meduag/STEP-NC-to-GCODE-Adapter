...
import br.UNB.LAB.InfAvancadas.MapearOperacoesDaFeature;
...
public class FeaturePoket {
	...
	static int finFer=1;//final de ferramentas
	static int sigT = 1;
		...
		if(actAsig==1){
		 do{//asignacion de direcciones
			...
			/*************************** Fin Profundidad ******************************************/
				...
				if(ctokens==(sigDir+7) | ctokens==(sigDir+8)){//copia el primer token con la primera ferramenta
					if(finFer==0 & sigT==0){
					//System.out.println(data);//imrpimo los valores mas un contador
					...
					if(aCaracteres[0]==dol | aCaracteres[0]==vir | aCaracteres[0]==parI | aCaracteres[0]==num){//solo copia numeros						
						//System.out.println("Es el simbolo de dolar o un numeral");
							...
							if(data2.contains("=TOLERANCED_LENGTH_MEASURE(")){
								System.out.println("Planar Radius: "+TooLM.ExtrairDadosTLM(SecEnder.IndexacaoEnderecos.get(TempEnd)));
				...
				/*************************** Fin Diametro de la base del Pocket      ******************************************/
					...
					if(ctokens==(sigDir+11) | ctokens==(sigDir+10)){//copia el primer token con la primera ferramenta
						if(finFer==0){
						
						System.out.println();
						
						/*System.out.println(ctokens);
						System.out.println((sigDir+7));
						System.out.println((sigDir+8));
						System.out.println(finFer);
						System.out.println(sigT);*/
